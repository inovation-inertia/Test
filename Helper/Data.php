...
namespace Custom\Autocomplete\Helper;

use Magento\Store\Model\ScopeInterface;

/**
 * Autocomplete config data helper
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    const XML_PATH_SEARCH_DELAY = 'custom_autocomplete/autocomplete_main/search_delay';

    /**
     * XML config path autocomplete fields
     */
    const XML_PATH_AUTOCOMPLETE_FIELDS = 'custom_autocomplete/autocomplete_main/autocomplete_fields';

    /**
     * XML config path suggest results number
     */
    const XML_PATH_SUGGESTED_RESULT_NUMBER = 'custom_autocomplete/autocomplete_main/suggested_result_number';

    /**
     * XML config path product results number
     */
    const XML_PATH_PRODUCT_RESULT_NUMBER = 'custom_autocomplete/autocomplete_main/product_result_number';
