...
use \Custom\Autocomplete\Model\Source\ProductFields;

/**
 * Product model. Return product data used in search autocomplete
 */
class Product implements \Custom\Autocomplete\Model\SearchInterface
{
    /**
    ...
    {
        /** @var \Custom\Autocomplete\Block\Autocomplete\Product $product */
        $product = $this->objectManager->create('Custom\Autocomplete\Block\Autocomplete\ProductAgregator')
                                       ->setProduct($product);
